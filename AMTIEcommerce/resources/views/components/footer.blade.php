                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-3">
                            <div class="menu">
                                ...
                                <a href="{{ route('comoFunciona') }}" class="a_none_style txt-color-parrafo">
                                    <h6 class="regular mb-3">¿Cómo funciona?</h6>
                                </a>
                                <a href="{{ route('vigencias') }}" class="a_none_style txt-color-parrafo">
                                    <h6 class="regular">Vigencias y precios</h6>
                                </a>
                                <a href="" class="a_none_style txt-color-parrafo">
                                    <h6 class="regular">Contacto</h6>
                                </a>
                                <a href="{{ route('faq') }}" class="a_none_style txt-color-parrafo">
                                    <h6 class="regular">FAQ’s</h6>
                                </a>
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-12 col-lg-3">
                            <div class="legal">
                                ...
                                <a href="" class="a_none_style txt-color-parrafo">
                                    <h6 class="regular mb-3">Términos y condiciones</h6>
                                </a>
                                <a href="" class="a_none_style txt-color-parrafo">
                                    <h6 class="regular mb-3">Aviso de Privacidad</h6>
                                </a>
                                <a href="" class="a_none_style txt-color-parrafo">
                                    <h6 class="regular">Políica de Cookies</h6>
                                </a>
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-12 col-lg-3">
